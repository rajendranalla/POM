...
public class TestBase {
	...
	public static Properties OR = new Properties(); // Object Repository properties initialization
	public static Properties config = new Properties(); // Config properties initialization
